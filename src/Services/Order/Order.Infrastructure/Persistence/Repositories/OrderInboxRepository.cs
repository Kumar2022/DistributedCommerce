...
/// <summary>
/// Repository for managing inbox messages in Order service.
/// Provides idempotent event consumption via EventId deduplication.
/// </summary>
public sealed class OrderInboxRepository : IInboxRepository
{
    private readonly OrderInfrastructureDbContext _dbContext;

    public OrderInboxRepository(OrderInfrastructureDbContext dbContext)
    {
