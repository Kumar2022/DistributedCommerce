...
public sealed class CatalogOutboxRepository(CatalogDbContext dbContext) : IOutboxRepository
{
    ...
    public async Task AddAsync(OutboxMessage message, CancellationToken cancellationToken = default)
    {
        ...
        if (_dbContext.OutboxMessages != null) await _dbContext.OutboxMessages.AddAsync(message, cancellationToken);
