...
/// <summary>
/// Repository for managing dead letter queue messages in Payment service.
/// Stores permanently failed messages for manual intervention.
/// </summary>
public sealed class PaymentDeadLetterQueueRepository : IDeadLetterQueueRepository
{
    private readonly PaymentDbContext _dbContext;

    public PaymentDeadLetterQueueRepository(PaymentDbContext dbContext)
    {
