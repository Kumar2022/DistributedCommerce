...
/// <summary>
/// Repository for managing outbox messages in Payment service.
/// Provides transactional outbox pattern for reliable event publishing.
/// </summary>
public sealed class PaymentOutboxRepository : IOutboxRepository
{
    private readonly PaymentDbContext _dbContext;

    public PaymentOutboxRepository(PaymentDbContext dbContext)
    {
