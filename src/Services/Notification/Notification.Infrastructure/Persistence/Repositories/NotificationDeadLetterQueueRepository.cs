...
public sealed class NotificationDeadLetterQueueRepository : IDeadLetterQueueRepository
{
    private readonly NotificationDbContext _dbContext;

    public NotificationDeadLetterQueueRepository(NotificationDbContext dbContext)
    {
